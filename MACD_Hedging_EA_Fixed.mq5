...
#property description "MACD-based Expert Advisor with Hedging Logic - Fixed Version"
#property strict
...
void CheckDailyReset()
{
    ...
    //--- Update daily profit (this should be done differently in production)
    // dailyProfit += GetTotalProfit(); // Commented out to avoid accumulation
}
